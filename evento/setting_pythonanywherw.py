...
def _build_csrf_trusted_origins():
    ...
    origins = {
        "https://motasevent.pythonanywhere.com",
...
EMAIL_USE_TLS = str(os.environ.get("EMAIL_USE_TLS", "True")).strip().lower() in {
    "1",
    "true",
    "yes",
    "on",
...
WHATSAPP_MEDIA_BASE_URL = os.environ.get(
