...
class Asistente(models.Model):
    ...
    cc = models.CharField(max_length=20, unique=True, primary_key=True, verbose_name="Cédula")
...
class VentaBarra(models.Model):
    ...
    """
    asistente = models.ForeignKey(Asistente, on_delete=models.SET_NULL, null=True, blank=True)
    producto = models.ForeignKey(Producto, on_delete=models.CASCADE)
    cantidad = models.IntegerField()
