...
urlpatterns = [
    ...
    path('productos/<int:pk>/editar/', views_barra.editar_producto, name='editar_producto'),
    path('productos/<int:pk>/ajustar-stock/', views_barra.ajustar_stock, name='ajustar_stock'),
    
    # Movimientos de stock
    path('movimientos/', views_barra.movimientos_stock, name='movimientos_stock'),
    path('movimientos/registrar/', views_barra.registrar_movimiento, name='registrar_movimiento'),
    ...
    # Exportar datos
    path('exportar/inventario/', views_barra.exportar_inventario, name='exportar_inventario'),
    path('exportar/ventas/', views_barra.exportar_ventas, name='exportar_ventas'),
    path('exportar/movimientos/', views_barra.exportar_movimientos, name='exportar_movimientos'),
]