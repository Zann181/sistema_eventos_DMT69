...
urlpatterns = [
    ...
    path(
        "asistentes/<str:cc>/editar/",
        views_entrada.editar_asistente,
        name="editar_asistente",
    ),
    path("asistentes/<str:cc>/qr/", views_entrada.ver_qr, name="ver_qr"),
    path(
        "asistentes/<str:cc>/eliminar/",
        views_entrada.eliminar_asistente,
        name="eliminar_asistente",
    ),
    # Generación de QR
