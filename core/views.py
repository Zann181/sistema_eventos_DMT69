        ...
        try:
            with transaction.atomic():
                ...
                if Asistente.objects.filter(cc=cc).exists():
                    ...
                    messages.success(request, f'Asistente {asistente.nombre} creado exitosamente')
...
def editar_asistente(request, cc):
    ...
    return render(request, 'core/editar_asistente.html', {
        'asistente': asistente, 
        'categorias': categorias
    })
...
def verificar_qr(request):
    try:
        ...
        try:
            ...
            return JsonResponse({'success': False, 'message': 'Código QR inválido o no encontrado'})
    ...
    try:
        ...
        return JsonResponse({
            ...
            'asistente': {
                ...
                'consumos': asistente.consumos_disponibles,
                'verificado_por': asistente.usuario_entrada.username if asistente.usuario_entrada else None
            }
        })
    except Asistente.DoesNotExist:
        return JsonResponse({'success': False, 'message': 'Asistente no encontrado con esa cédula'})
...
def marcar_ingreso(request):
    try:
        ...
        if asistente.ha_ingresado:
            return JsonResponse({'success': False, 'message': 'El asistente ya había ingresado'})
...
def eliminar_asistente(request):
    try:
        ...
        if asistente.ha_ingresado:
            return JsonResponse({'success': False, 'message': 'No se puede eliminar un asistente que ya ingresó'})
        ...
        return JsonResponse({
            'success': True,
            'message': f'{nombre} eliminado exitosamente'
        })
...
def buscar_asistente_qr(request):
    ...
    try:
        ...
        return JsonResponse({'success': False, 'message': 'Asistente no encontrado o QR inválido'})
...
def verificar_qr(request):
    try:
        ...
        return JsonResponse({'success': False, 'message': 'Asistente no encontrado para confirmar'})
    except Exception as e:
        return JsonResponse({'success': False, 'message': f'Error interno: {str(e)}'})
