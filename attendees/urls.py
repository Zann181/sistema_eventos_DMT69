...
urlpatterns = [
    ...
    path("expenses/<int:movement_id>/update/", views.attendee_expense_update, name="expense_update"),
    path("expenses/<int:movement_id>/delete/", views.attendee_expense_delete, name="expense_delete"),
    path("cash-drop/new/", views.attendee_cash_drop_create, name="cash_drop_create"),
    path("cash-drop/<int:movement_id>/update/", views.attendee_cash_drop_update, name="cash_drop_update"),
    path("cash-drop/<int:movement_id>/delete/", views.attendee_cash_drop_delete, name="cash_drop_delete"),
    ...
    path("share/<str:qr_code>/flyer.webp", views.attendee_whatsapp_flyer_file, name="whatsapp_flyer_file"),
    path("share/<str:qr_code>/flyer.jpg", views.attendee_whatsapp_flyer_file, name="whatsapp_flyer_file_legacy"),
